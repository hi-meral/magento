...
namespace Espl\HelloWorld\Controller\User;

use Magento\Framework\App\Action\Action;
use Magento\Framework\App\Action\Context;
use Magento\Framework\App\ResponseInterface;
use Espl\HelloWorld\Model\Post as User;
use Espl\HelloWorld\Model\ResourceModel\Post as UserResource;
...
class Add extends Action
{
    ...
    public function execute()
    {
        ...
        $redirect->setPath('helloworld/user/view');
        return $redirect;
    }
}
